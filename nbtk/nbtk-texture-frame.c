...
G_DEFINE_TYPE (NbtkTextureFrame,
	       nbtk_texture_frame,
	       CLUTTER_TYPE_CLONE_TEXTURE);

#define NBTK_TEXTURE_FRAME_GET_PRIVATE(obj) \
(G_TYPE_INSTANCE_GET_PRIVATE ((obj), NBTK_TYPE_TEXTURE_FRAME, NbtkTextureFramePrivate))
...
nbtk_texture_frame_paint (ClutterActor *self)
{
  ...
  priv = NBTK_TEXTURE_FRAME (self)->priv;
...
static void
nbtk_texture_frame_set_property (GObject      *object,
				    guint         prop_id,
				    const GValue *value,
				    GParamSpec   *pspec)
{
  NbtkTextureFrame         *ctexture = NBTK_TEXTURE_FRAME (object);
  NbtkTextureFramePrivate  *priv = ctexture->priv;  
...
static void
nbtk_texture_frame_get_property (GObject    *object,
				    guint       prop_id,
				    GValue     *value,
				    GParamSpec *pspec)
{
