/*
 * nbtk-utils.c: General utility functions used in Moblin
 *
 ...
 */
gchar *
nbtk_utils_format_time (GTimeVal *time_)
{
  GTimeVal now;
  struct tm tm_mtime;
  gchar *retval = NULL;
