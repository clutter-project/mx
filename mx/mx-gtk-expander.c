/*
 * mx-gtk-expander.c: GTK+ Expander widget with extra styling properties
 *
...
G_DEFINE_TYPE (MxGtkExpander, mx_gtk_expander, GTK_TYPE_BIN)
                              ...
                              GdkEventExpose *event)
{
  if (GTK_WIDGET_DRAWABLE (widget))
    {
      MxGtkExpanderPrivate *priv = MX_GTK_EXPANDER (widget)->priv;
...
static void
mx_gtk_expander_map (GtkWidget *widget)
{
  MxGtkExpanderPrivate *priv = ((MxGtkExpander*) widget)->priv;
...
static void
mx_gtk_expander_unmap (GtkWidget *widget)
{
  MxGtkExpanderPrivate *priv = ((MxGtkExpander*) widget)->priv;
                     ...
                     GtkWidget    *widget)
{
  ...
  gtk_widget_set_child_visible (widget, MX_GTK_EXPANDER (container)->priv->is_open);
                                ...
                                GdkEventButton *event)
{
  ...
  mx_gtk_expander_set_expanded ((MxGtkExpander *) widget, !priv->is_open);
...
mx_gtk_expander_unrealize (GtkWidget *widget)
{
  ...
  GTK_WIDGET_CLASS (mx_gtk_expander_parent_class)->unrealize (widget);
}
                              ...
                              GParamSpec   *pspec)
{
  ...
  switch (property_id)
    {
    case PROP_EXPANDED:
      mx_gtk_expander_set_expanded (expander, g_value_get_boolean (value));
      break;

    case PROP_LABEL_WIDGET:
      mx_gtk_expander_set_label_widget (expander, g_value_get_object (value));
      break;
...
static void
mx_gtk_expander_class_init (MxGtkExpanderClass *klass)
{
  ...
  g_type_class_add_private (klass, sizeof (MxGtkExpanderPrivate));

  object_class->set_property = mx_gtk_expander_set_property;
  object_class->get_property = mx_gtk_expander_get_property;

  widget_class->expose_event = mx_gtk_expander_expose_event;
  widget_class->style_set = mx_gtk_expander_style_set;

  widget_class->size_request = mx_gtk_expander_size_request;
  widget_class->size_allocate = mx_gtk_expander_size_allocate;

  widget_class->realize = mx_gtk_expander_realize;
  widget_class->unrealize = mx_gtk_expander_unrealize;
  widget_class->map = mx_gtk_expander_map;
  widget_class->unmap = mx_gtk_expander_unmap;

  container_class->add = mx_gtk_expander_add;
  container_class->remove = mx_gtk_expander_remove;
  container_class->forall = mx_gtk_expander_forall;

  widget_class->button_release_event = mx_gtk_expander_button_release;
...
static void
mx_gtk_expander_init (MxGtkExpander *self)
{
  MxGtkExpanderPrivate *priv;

  self->priv = G_TYPE_INSTANCE_GET_PRIVATE (self,
                                            MX_TYPE_GTK_EXPANDER,
                                            MxGtkExpanderPrivate);
 ...
 * mx_gtk_expander_new:
 *
 * Create a new #MxGtkExpander.
 *
 * Returns: a newly allocated #MxGtkExpander
 */
GtkWidget*
mx_gtk_expander_new (void)
{
  return g_object_new (MX_TYPE_GTK_EXPANDER, NULL);
}

/**
 * mx_gtk_expander_set_expanded:
 * @expander: A #MxGtkExpander
                              ...
                              gboolean       expanded)
{
  ...
  priv = ((MxGtkExpander*) expander)->priv;
 ...
 */
gboolean
mx_gtk_expander_get_expanded (MxGtkExpander *expander)
{
  g_return_val_if_fail (MX_IS_GTK_EXPANDER (expander), FALSE);

  return expander->priv->is_open;
}

/**
 * mx_gtk_expander_set_label_widget:
 * @expander: A #MxGtkExpander
 * @label: A #GtkWidget
 *
...
/**
 * mx_gtk_expander_get_label_widget:
 * @expander: A #MxGtkExpander
 *
 ...
 */
GtkWidget*
mx_gtk_expander_get_label_widget (MxGtkExpander *expander)
{
  g_return_val_if_fail (MX_IS_GTK_EXPANDER (expander), NULL);

  return expander->priv->label;
}

/**
 * mx_gtk_expander_set_has_indicator:
 * @expander: A #MxGtkExpander
...
/**
 * mx_gtk_expander_get_has_indicator:
 * @expander: A #MxGtkExpander
 *
 ...
 */
gboolean
mx_gtk_expander_get_has_indicator (MxGtkExpander *expander)
{
  g_return_val_if_fail (MX_IS_GTK_EXPANDER (expander), 0);
