...
struct _MxEntryPrivate
{
  ...
  const gchar  *primary_icon_filename;
  const gchar  *secondary_icon_filename;

  const gchar  *icon_highlight_suffix;
                                     ...
                                     const gchar *filename)
{
  ...
  priv->primary_icon_filename = filename;
                                       ...
                                       const gchar *filename)
{
  ...
  priv->secondary_icon_filename = filename;
...
mx_entry_set_icon_highlight_suffix (MxEntry *entry, const gchar* suffix)
{
  ...
  priv->icon_highlight_suffix = suffix;
